...
<body class=" min-w-full min-h-full bg-[#FAFCFF]  " style="font-family: 'Montserrat', sans-serif;">
	<section class=" h-full flex flex-col items-center justify-center">
		...
		<div class="col-span-4 bg-white rounded-lg h-fit mx-5 max-w-max min-w-fit flex-col items-center flex p-10">
			...
			<div class="text-sm my-5 text-center text-[#82899B]">Enter your credentials to access your account</div>
			@if($errors->any())
			<div class="text-xs text-red-700">{{$errors->first()}}</div>
			@endif
			<form action="/login" method="post" class="flex flex-col w-full h-full">
				@csrf 
				...
				<button class="bg-[#315EFB] mt-s rounded-lg text-white h-10 mt-5 py-2 px-10 flex items-center justify-center" type="submit">Sign In</button>
		...
		<div class="mt-10 text-sm text-[#82899B]">Forgot your password?  <a class="text-[#315EFB]" href="">Reset password</a></div>
	</section>
</body>
</html>